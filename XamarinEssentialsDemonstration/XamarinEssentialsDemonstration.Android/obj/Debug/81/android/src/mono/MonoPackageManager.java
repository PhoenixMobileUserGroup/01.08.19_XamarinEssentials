...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinEssentialsDemonstration.Android.dll" comes first in this list. */
		"XamarinEssentialsDemonstration.Android.dll",
		"FormsViewGroup.dll",
		"PropertyChanged.dll",
		...
		"XamarinEssentialsDemonstration.dll",
	};
